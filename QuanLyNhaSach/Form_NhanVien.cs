...
namespace QuanLyNhaSach
{
    public partial class Form_NhanVien : Form
    {
        ...
        private void chinhFocusTextBox()
        {
            txb_hoten.Focus();
            txb_hoten.SelectionStart = txb_hoten.TextLength;
            txb_hoten.SelectionLength = 0;
            txb_manv.SelectionStart = txb_manv.TextLength;
            txb_manv.SelectionLength = 0;
            txb_diachi.SelectionStart = txb_diachi.TextLength;
            txb_diachi.SelectionLength = 0;
            txb_matkhau.SelectionStart = txb_matkhau.TextLength;
            txb_matkhau.SelectionLength = 0;
            txb_taikhoan.SelectionStart = txb_taikhoan.TextLength;
            txb_taikhoan.SelectionLength = 0;
            txb_sdt.SelectionStart = txb_sdt.TextLength;
            txb_sdt.SelectionLength = 0;
