...
namespace QuanLyNhaSach
{
    public partial class FormNhanVien : Form
    {
        ...
        private void HienThiDanhSach()
        {
            ...
            sqlCmd.CommandText = "select tennv, diachi, sdt, ngaythangnamsinh, tenvt, taikhoan, matkhau\r\nfrom nhan_vien  t inner join vai_tro vt on t.mavt = vt.mavt\r\n";
        ...
        private void btn_tim_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand sqlCmd = new NpgsqlCommand();
            sqlCmd.CommandType = CommandType.Text;
            sqlCmd.CommandText = "select tennv, diachi, sdt, ngaythangnamsinh, tenvt, taikhoan, matkhau\r\nfrom nhan_vien  t inner join vai_tro vt on t.mavt = vt.mavt where tennv like @tennv\r\n";

            sqlCmd.Connection = connpg;

            sqlCmd.Parameters.AddWithValue("@tennv",txb_timkiem.Text);
        ...
        private void lsv_danhsachnv_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txb_hoten.Text = lvi.SubItems[0].Text;
            txb_diachi.Text = lvi.SubItems[1].Text;
            txb_dienthoai.Text = lvi.SubItems[2].Text;
            txb_ngaysinh.Text = lvi.SubItems[3].Text;
            cbx_vaittro.Text = lvi.SubItems[4].Text;
            txb_taikhoan.Text = lvi.SubItems[5].Text;
            txb_matkhau.Text = lvi.SubItems[6].Text;
        }
        ...
        private void btn_capnhat_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "UPDATE nhan_vien SET tennv = @tennv, diachi = @diachi, sdt = @sdt, mavt = @mavt, ngaythangnamsinh = @ngaythangnamsinh, taikhoan = @taikhoan, matkhau = @matkhau WHERE tennv = @tennv";
                using (NpgsqlCommand command = new NpgsqlCommand(sql, connpg))
                {
                    command.Parameters.AddWithValue("@tennv", txb_hoten.Text);
                    command.Parameters.AddWithValue("@diachi", txb_diachi.Text);
